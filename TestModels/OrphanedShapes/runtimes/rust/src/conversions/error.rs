    ...
    ::std::rc::Rc<crate::r#simple::orphaned::internaldafny::types::Error>
{
    ...
    ::std::rc::Rc::new(
        crate::r#simple::orphaned::internaldafny::types::Error::OpaqueWithText {
            obj: error_obj,
...
pub fn to_dafny(
    ...
    ::std::rc::Rc::new(match value {
        crate::types::error::Error::OrphanedError { message } =>
    crate::r#simple::orphaned::internaldafny::types::Error::OrphanedError {
        ...
        crate::types::error::Error::CollectionOfErrors { list, message } =>
            crate::r#simple::orphaned::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
        ...
        crate::types::error::Error::ValidationError(inner) =>
            crate::r#simple::orphaned::internaldafny::types::Error::Opaque {
                obj: {
...
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<
        crate::r#simple::orphaned::internaldafny::types::Error,
    >,
) -> crate::types::error::Error {
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        crate::r#simple::orphaned::internaldafny::types::Error::OrphanedError { message } =>
    crate::types::error::Error::OrphanedError {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
    },
        crate::r#simple::orphaned::internaldafny::types::Error::CollectionOfErrors { list, message } =>
        ...
        crate::r#simple::orphaned::internaldafny::types::Error::Opaque { obj } =>
            ...
            crate::r#simple::orphaned::internaldafny::types::Error::OpaqueWithText { obj, objMessage } =>
            {
                use ::std::any::Any;
                if ::dafny_runtime::is_object!(obj, crate::types::error::ValidationError) {
                    let typed = ::dafny_runtime::cast_object!(obj.clone(), crate::types::error::ValidationError);
