...
pub mod internal_SimpleOrphanedImpl_Compile {

    use crate::conversions::*;
    use crate::types::*;
    use crate::implementation_from_dafny::_OrphanedResource_Compile::*;
    use crate::implementation_from_dafny::_SimpleOrphanedImpl_Compile::_default;
    ...
    impl _default {
        ...
        pub fn CallNativeOrphanedError(
            ...
            let native_error_new = crate::types::error::Error::OrphanedError {
               message :  "the extern MUST use Smithy-generated conversions to set this value in the native error".to_string()
            };
