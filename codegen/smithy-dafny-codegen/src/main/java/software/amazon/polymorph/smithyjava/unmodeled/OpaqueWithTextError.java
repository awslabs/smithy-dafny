...
import static software.amazon.polymorph.smithyjava.BuilderMemberSpec.OPAQUE_WITH_TEXT_ARGS;
...
/**
 * OpaqueWithTextError is a Native-Java allegory to smithy-dafny's
 * {@code datatype Error}'s {@code OpaqueWithText(obj: object, objMessage: string)} constructor<p>
 * There is no Smithy Shape for this.<p>
 */
public class OpaqueWithTextError {

  public static final String OPAQUE_ERROR = "OpaqueWithTextError";
  ...
  /** A JavaFile containing the OpaqueWithTextError class definition. */
  ...
  static MethodSpec builderImplConstructor(String packageName) {
    return MethodSpec
      ...
      .addStatement("this.objMessage = model.objMessage()")
      .build();
  }
